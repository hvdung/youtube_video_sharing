        ...
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-6">
              <button
                onClick={() => router.push('/videos')}
                className={`px-4 py-2 rounded-md text-sm font-medium ${pathname === '/videos' || pathname === '/'
              ...
              {user && (
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-medium ${pathname.includes('/users')
                    ? 'bg-gray-100 text-gray-900'
                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                    }`}
                >
          ...
          <div className="flex items-center gap-6">
            {user ? (
              ...
              <button
                ...
                className="px-6 py-2 text-sm font-medium text-white bg-gray-900 hover:bg-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors"
              >
                Login
              </button>
            )}
